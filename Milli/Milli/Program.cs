...
namespace Assignment
{
	...
	class Program
	{
		static void Main()
		{
			...
			string[] ans = new string[12] { "a", "b", "d", "c", "a", "d", "b", "a", "c", "a", "d", "b" };
			questionare[] answers = new questionare[60];
		...
		//	while (!sr.EndOfStream)
		//	{
		//		answers[count].questions = sr.ReadLine();
		//		answers[count].a = sr.ReadLine();
		//		answers[count].b = sr.ReadLine();
		//		answers[count].c = sr.ReadLine();
		//		answers[count].d = sr.ReadLine();
		//		count++;
		//	}
		//	sr.Close();
		//}
		...
		//		{
		//			string[] ans = new string[12] { "a", "b", "d", "c", "a", "d", "b", "a", "c", "a", "d", "b" };
		//			questionare[] answers = new questionare[14];
		...
		//			sr.Close();
		//		}
		//		public static void displayquestions(questionare[] answers)
		//		{
		//			for (int i = 0; i < answers.Length; i++)
		//			{
		//				Console.WriteLine($"\n{answers[i].questions}\n");
		//				Console.WriteLine($"{answers[i].a}");
		//				Console.WriteLine($"{answers[i].b}");
		//				Console.WriteLine($"{answers[i].c}");
		//				Console.WriteLine($"{answers[i].d}");
		//			}
		//			Console.ReadLine();
		//		}
		//		public static void Game(questionare[] answers)
		//		{
		//			displayquestions(answers);
		//			Thread.Sleep(5000);
		//			Console.Clear();
